...
/**
 * Shared confirm dialog for suspending an enterprise (list ⋮ menu, detail header, etc.).
 */
export default function SuspendEnterpriseConfirmModal({
  open,
  enterpriseName,
  onClose,
  onConfirm,
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="suspend-enterprise-title"
      onClick={(ev) => {
    ...
    >
      <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white shadow-xl">
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 px-5 py-4">
          <h2 id="suspend-enterprise-title" className="text-[16px] font-semibold text-slate-900">
            Suspend Enterprise
          </h2>
          <button
            type="button"
        ...
        <div className="px-5 py-4">
          <p className="text-[13px] leading-relaxed text-slate-600">
            ...
            products will be hidden until reactivated.
          </p>
        </div>
